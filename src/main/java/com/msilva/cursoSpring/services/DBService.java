...
import com.msilva.cursoSpring.repositories.EstadoRepository;
...
/**
 * Provê serviços de Banco de dados.
 *
 * @author Mateus
 */
@Service
public class DBService {
    ...
    /**
     * Instância os dados do banco de dados de Teste.
     *
     * @throws ParseException
     */
    public void instanciarBancoDadosTeste() throws ParseException {
        ...
        cat1.getProdutos().addAll(Arrays.asList(p12, p13, p14, p15, p16, p17,
                p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29,
                p30, p31, p32, p34, p35, p36, p37, p38, p39, p40, p41, p42,
        ...
        produtoRepository.saveAll(Arrays.asList(p12, p13, p14, p15, p16, p17,
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "hervatin.mateus@gmail.com",
                "36378912377", TipoCliente.PESSOA_FISICA, bcpe.encode("123"));
...
//        cli2.addPerfil(Perfil.ADMIN);
        ...
        Pagamento pagto1 = new PagamentoComCartao(null, 6,
                EstadoPagamento.QUITADO, ped1);

        ped1.setPagamento(pagto1);

        Pagamento pagto2 = new PagamentoComBoleto(null,
                sdf.parse("20/10/2017 00:00"), null, EstadoPagamento.PENDENTE,
                ped2);
