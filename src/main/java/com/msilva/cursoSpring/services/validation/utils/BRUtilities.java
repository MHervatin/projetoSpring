package com.msilva.cursoSpring.services.validation.utils;

/**
 * Utilitário de validação para campos brasileiros.
 *
 * @author Mateus
 */
public class BRUtilities {
     ...
     * Valida o CPF
     *
     * @param ssn O SSN do CPF.
     *
     * @return {@code True} se o CPF é válido; Caso contrário {@code false}.
     */
     ...
     * Valida o CNPJ
     *
     * @param tin o TIN do CNPJ.
     *
     * @return {@code True} se o CNPJ é válido; Caso contrário {@code false}.
     */
    public static boolean isValidCNPJ(final String tin) {
        if ((tin == null)
                || (tin.length() != 14)
                || tin.matches(tin.charAt(0) + "{14}")) {
            return false;
        }
